...
{
    [Fact]
    public void CreateUserCommand_Should_Be_Record()
    {
        // Act & Assert
        Assert.True(typeof(CreateUserCommand).IsAssignableTo(typeof(IEquatable<CreateUserCommand>)));
    }
    ...
    [Fact]
    public void CreateUserCommand_Should_Have_Default_IsEnabled_True()
    {
        // Act
        var command = new CreateUserCommand(
    ...
    [Fact]
    public void CreateUserCommand_Should_Support_Equality_Comparison()
    {
        // Arrange
    ...
    [Fact]
    public void CreateUserCommand_Should_Support_Inequality_Comparison()
    {
        // Arrange
        var command1 = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
        ...
        var command2 = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
            UserId: "jane.doe", // Different UserId
    ...
    [Fact]
    public void CreateUserCommand_Should_Have_Consistent_HashCode()
    {
        // Arrange
        var command1 = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    ...
    [Fact]
    public void CreateUserCommand_Should_Support_With_Expression_For_GraphId()
    {
        // Arrange
        var originalCommand = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
            UserId: "john.doe",
            DisplayName: "John Doe",
            PrincipalName: "john.doe@company.com",
        ...
        var newGraphId = "b2c3d4e5-f6g7-8901-bcde-f12345678901";

        // Act
        var modifiedCommand = originalCommand with { GraphId = newGraphId };

        // Assert
        Assert.Equal(newGraphId, modifiedCommand.GraphId);
    ...
    [Fact]
    public void CreateUserCommand_Should_Support_With_Expression_For_IsEnabled()
    {
        // Arrange
        var originalCommand = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    ...
    public void CreateUserCommand_Should_Accept_Valid_GraphId_Formats(string graphId)
    {
        // Act
        var command = new CreateUserCommand(
            GraphId: graphId,
    ...
    [InlineData("user123")]
    public void CreateUserCommand_Should_Accept_Valid_UserId_Formats(string userId)
    {
        // Act
        var command = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    ...
    public void CreateUserCommand_Should_Accept_Valid_PrincipalName_Formats(string principalName)
    {
        // Act
        var command = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    ...
    public void CreateUserCommand_Should_Accept_Valid_DisplayName_Formats(string displayName)
    {
        // Act
        var command = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    ...
    [InlineData(true)]
    [InlineData(false)]
    public void CreateUserCommand_Should_Accept_Both_IsEnabled_Values(bool isEnabled)
    {
        // Act
        var command = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    ...
    [Fact]
    public void CreateUserCommand_Should_Have_Meaningful_ToString()
    {
        // Arrange
        var command = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
        ...
        // Assert
        Assert.Contains("CreateUserCommand", stringRepresentation);
        Assert.Contains("john.doe", stringRepresentation);
        Assert.Contains("John Doe", stringRepresentation);
    }

    [Fact]
    public void CreateUserCommand_Should_Support_Deconstruction()
    {
        // Arrange
        var command = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
        ...
        // Act
        var (graphId, userId, displayName, principalName, isEnabled) = command;
    ...
    [Fact]
    public void CreateUserCommand_Should_Support_Multiple_With_Expressions()
    {
        // Arrange
        var originalCommand = new CreateUserCommand(
            GraphId: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
