...
public class CreateUserCommandValidatorTests
{
    ...
    #region GraphId Tests - No Validation Required
    
    // NOTE: GraphId is now auto-generated in CreateUserCommandHandler using Guid.NewGuid().ToString()
    // The input GraphId parameter is ignored, so no validation is performed on this field
    // These tests verify that the validator accepts any GraphId value since it's not validated
    ...
    public void GraphId_Should_NotBeValidated_SinceItIsAutoGenerated(string anyGraphId)
    {
        // Arrange
